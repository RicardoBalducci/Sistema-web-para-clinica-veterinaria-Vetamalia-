                ...
                <tbody>
                    ...
                    while($row =mysqli_fetch_array($result)) {?>
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?php echo $row['codigo_especie']?>" class="btn btn-outline-light" type="button" style="background-color: #6a6aeb"  onclick="return  ConfirmarEditar()">
                                    <i class="fas fa-marker"></i>
                                </a>
                                <a href="delete.php?id=<?php echo $row['codigo_especie']?>" class="btn btn-outline-light" type="button" style="background-color: #fa9543" onclick="return ConfirmarEliminar()">
