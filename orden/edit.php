...
$descripcion = '';
    ...
    if(isset($_GET['id'])){
        ...
        $query = "SELECT * FROM orden WHERE codigo_orden=$codigo";
    ...
    if (isset($_POST['update'])){
        ...
        $query = "UPDATE orden set descripcion = '$descripcion' WHERE codigo_orden=$id";
            ...
            <div class="card card-body">
                ...
                <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    <div class="form-group">
                        <p class="h7">Codigo del orden</p>
                        <input name="codigo" type="text" class="form-control" class="display-1"  value="<?php echo $codigo; ?>" placeholder="Reemplace Orden" aria-label="Disabled input example" disabled>
                    </div><br>
                    <div class="form-group">
