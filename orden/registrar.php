...
<div class="container p-4">
        <img src="../img/Orden.png" class="rounded mx-auto d-block" width="160" height="35"></a>
    <div class="row">
            ...
            <div class="card card-body"> 
                ...
                <form action="registrar.php">
                        <div class="form-group"><!---->
                            <p class="h7">Nombre del orden</p>
                            <input type="text" name="nombre" class="form-control" placeholder="Ingrese nombre del orden" required  onkeypress="return soloLetras(event)">
                            <!--CAMBIAR BOTON AQUI -->
                    ...
                    <?php
                        if(isset($_GET['nombre'])){
                            $nombre=$_GET['nombre'];
                            $sql = "SELECT * FROM orden WHERE descripcion LIKE '%$nombre%'";
                            $result = $conn->query($sql);
                            if($rowe = $result->fetch_assoc()){
                                echo "<script> alert('El orden ya se encuentra registrado'); </script>";
                                ?>
                                <div class="form-group">
                                    <p class="h7">Código del orden:</p>
                                    <input type="text" name="descripcion" value="<?php echo $rowe['codigo_orden']; $nombre2 = $rowe['codigo_orden'];?>" class="form-control"required placeholder="Ingrese el nombre del orden"  onkeypress="return soloLetras(event)" onblur="limpia()" id="miInput">
                                </div><br>
                                <div class="form-group">
                                    <p class="h7">Nombre del orden:</p>
                                    <input type="text" name="descripcion" value="<?php echo $rowe['descripcion']; $nombre2 = $rowe['descripcion'];?>"  class="form-control"required placeholder="Ingrese el nombre del orden"  onkeypress="return soloLetras(event)" onblur="limpia()" id="miInput">
                                </div><br>
                                <a href="orden.php" class="btn btn-outline-light" type="button" style="background-color: #989cf3">Registrar</a>
...
<form id="combo" name="combo" action="save.php" method="POST" >
                    ...
                    <div class="form-group">
                        <p class="h7">Nombre de la orden</p>
