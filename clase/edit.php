...
$descripcion = '';
    ...
    if(isset($_GET['id'])){
        ...
        $query = "SELECT * FROM clase WHERE codigo_clase=$codigo";
    ...
    if (isset($_POST['update'])){
        ...
        $descripcion= $_POST['descripcion'];//queda igual
        $query = "UPDATE clase set descripcion = '$descripcion' WHERE codigo_clase=$id";
            ...
            <div class="card card-body">
                ...
                <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    <div class="form-group">
                        <p class="h7">Codigo de la clase: </p>
                        <input name="codigo" type="text" class="form-control" class="display-1"  value="<?php echo $codigo; ?>" placeholder="Remplace Clase" aria-label="Disabled input example" disabled>
                    </div><br>
                    <div class="form-group">
                        <p class="h7">Nombre de la clase:</p>
