...
<div class="container p-4">
        <img src="../img/Genero.png" class="rounded mx-auto d-block" width="160" height="35"></a>
    <div class="row">
            ...
            <div class="card card-body"> 
                ...
                <form action="registrar.php">
                        <div class="form-group"><!---->
                            <p class="h7">Nombre del genero</p>
                            <input type="text" name="nombre" class="form-control" placeholder="Ingrese nombre del genero" required  onkeypress="return soloLetras(event)">
                            <!--CAMBIAR BOTON AQUI -->
                    ...
                    <?php
                        if(isset($_GET['nombre'])){
                            $nombre=$_GET['nombre'];
                            $sql = "SELECT * FROM genero WHERE descripcion LIKE '%$nombre%'";
                            $result = $conn->query($sql);
                            if($rowe = $result->fetch_assoc()){
                                echo "<script> alert('El genero ya se encuentra registrado'); </script>";
                                ?>
                                <div class="form-group">
                                    <p class="h7">Código del género:</p>
                                    <input type="text" name="descripcion" value="<?php echo $rowe['codigo_genero']; $nombre2 = $rowe['codigo_genero'];?>" class="form-control"required placeholder="Ingrese el nombre del genero"  onkeypress="return soloLetras(event)" onblur="limpia()" id="miInput">
                                </div><br>
                                <div class="form-group">
                                    <p class="h7">Nombre del género:</p>
                                    <input type="text" name="descripcion" value="<?php echo $rowe['descripcion']; $nombre2 = $rowe['descripcion'];?>"  class="form-control"required placeholder="Ingrese el nombre del genero"  onkeypress="return soloLetras(event)" onblur="limpia()" id="miInput">
                                </div><br>
                                <a href="genero.php" class="btn btn-outline-light" type="button" style="background-color: #989cf3">Registrar</a>
