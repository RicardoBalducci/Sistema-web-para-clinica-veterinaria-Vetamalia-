...
$descripcion = '';
    ...
    if(isset($_GET['id'])){
        ...
        $query = "SELECT * FROM genero WHERE codigo_genero=$codigo";
    ...
    if (isset($_POST['update'])){
        ...
        $query = "UPDATE genero set descripcion = '$descripcion' WHERE codigo_genero=$id";
            ...
            <div class="card card-body">
                ...
                <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    <div class="form-group">
                        <p class="h7">Codigo del genero: </p>
                        <input name="codigo" type="text" class="form-control" class="display-1"  value="<?php echo $codigo; ?>" placeholder="Reemplace Género" aria-label="Disabled input example" disabled>
                    </div><br>
                    <div class="form-group">
